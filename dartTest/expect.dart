...
class expect {
  static void isTrue(bool statement) {
    if (!statement) {
      var anomaly = new _Result('Expected true statement is false.');
  ...
  static void isFalse(bool statement) {
    if (statement) {
      var anomaly = new _Result('Expected false statement is true.');
      Test._addEntry(anomaly);
    }
  }
  ...
  static void areEqual(actual, expected) {
    if (actual != expected) {
      var anomaly = new _Result('$actual does not equal $expected');
      Test._addEntry(anomaly);
    }
  }
  ...
  static void areUnequal(actual, expected) {
    if (actual == expected) {
      var anomaly = new _Result('Expected unequal values are equal.');
      Test._addEntry(anomaly);
    }
  }
